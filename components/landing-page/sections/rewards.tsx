...
export const RewardsSection = async ({ rewards }: { rewards: Reward[] }) => {
  return (
    <section id="rewards" className="container lg:w-[90%] xl:w-[80%] pb-16">
      <div className="text-center">
        ...
        <h3 className="md:w-2/3 lg:w-1/2 mx-auto text-base sm:text-lg text-muted-foreground mb-8">
      ...
      <h3 className="md:w-2/3 lg:w-1/2 mx-auto text-base sm:text-lg text-muted-foreground mt-8 text-center">
