...
const StatsCard = ({ name, value, description }: StatsCardProps) => {
  return (
    <BlurFade inView duration={1}>
      <Card
        className="relative overflow-hidden group transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 border-2 border-primary/20 hover:border-primary/40"
        role="region"
      ...
      >
        ...
        <div className="relative z-10 p-6 flex flex-col h-full">
          <div className="flex flex-col mb-4">
            ...
            <div
              className="mt-2 bg-primary/10 p-2 rounded-md inline-block group-hover:bg-primary/20 transition-colors duration-300"
              aria-live="polite"
            >
              {value > 0 ? (
                <NumberTicker
